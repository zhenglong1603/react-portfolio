            ...
            <div className="w-full lg:w-1/2">
                <div className="flex flex-col items-center lg:items-center">
                    ...
                    className="my-2 max-w-xl py-6 tracking-tighter text-justify text-center">
                        Welcome to my portfolio website! I&apos;m a Year 3 Computer Science student at the National University of Singapore (NUS). Passionate about Software Engineering and Network Systems, I enjoy collaborating with teams and working independently to solve challenging problems.
                    </motion.p>
