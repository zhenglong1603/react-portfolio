        ...
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-center">
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="pb-16 text-6xl font-thick tracking-tight lg:mp-16 lg:text-6xl text-center"
            >
              Sue Zheng Long
            </motion.h1>
            <motion.span
            ...
            >
              Welcome to my portfolio website! I&apos;m a Year 3 Computer
              Science student at the National University of Singapore (NUS).
              Passionate about Software Engineering and Network Systems, I enjoy
              collaborating with teams and working independently to solve
